...
class ImageProcessing extends PApplet {
  ...
  void setup() {
    ...
    //img = loadImage("C:\\Users\\Alexis Dewaele\\Documents\\Processing\\Game\\data\\board3.jpg");  
    cam = new Movie(this, "C:\\Users\\Alexis Dewaele\\Documents\\Processing\\Game\\data\\testvideo.mp4");
    cam.loop();
    proj = new TwoDThreeD(cam.width, cam.height);
  ...
  void draw() {
    ...
    //image(cam, 0, 0);
    hough(sobelImage, 4);
    graph.build(vectors, cam.width, cam.height);
    graph.findCycles();
